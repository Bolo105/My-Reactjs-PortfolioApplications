...
export const Calculator = () => {
  ...
  return (
    <Sec>
      <div id = 'calcapp' className="container my-2">
        <div className="row">
          ...
          <div className="col-md-4">
            <div class="card mb-3 pt-3 shadow">
              <div class="card-body text-primary">
                ...
                bg-light fs-4 text-primary shadow' value={val} onChange={(e) => setVal(e.target.value)}/>
                <div className='row'>
                   <div className='col-3'>
                   ...
                   <div className='col-3'>
                     <button className='btn btn-light text-primary shadow px-42 py-4 fs-4'
                     value='C' onClick={() => backspace()}>A/C</button>
                   </div>
                </div>
