...
function HomeComp06() {
  return (
       ...
       <Hero id="homecomp6" className="home d-flex align-items-center">
          <Container className="container" data-aos="zoom-out" data-aos-delay="100">
             <Head>My Car Rental Agency</Head>
             ...
             <div className="">
                ...
                <BtnStart href="#about" className="btn-get-started scrollto">Cars</BtnStart>
             </div>
          </Container>
       </Hero>
